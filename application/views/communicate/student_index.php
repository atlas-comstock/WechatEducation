	...
	<body>
		...
		<header data-am-widget="header" class="am-header am-header-default am-header-fixed">
			...
			<h1 class="am-header-title">
				...
				<a href="../main/index.html" class="">小组讨论</a>
		...
		<div class="n_option">
			<div class="new">
            <a href="<?php echo "index.php/communication/small_wechat/create_group/".$user_id; ?>">
					<button>创建小组</button></a>
			</div>
			<div class="goto">
            <a href="<?php echo "index.php/communication/small_wechat/show_groups/".$user_id; ?>">
				<button>进入小组</button>
				</a>
			</div>
			<div class="delete">
				<a href="delete_g.html">
				<button>删除小组</button>
				</a>
			</div>
