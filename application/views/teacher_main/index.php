...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="style/teacher_main/css/first.css" />

		<script type="text/javascript" src="style/teacher_main/assets/js/jquery.min.js"></script>
		<script type="text/javascript" src="style/teacher_main/assets/js/amazeui.min.js"></script>
	...
	<body>
		...
		<div id="cate10">
			<div class="catemenu">
				<ul>
					<li>
						<a href="a-student.html">
							<img src="img/1.png">学生事务</a>
					</li>
					<li>
						<a href="http://av.jejeso.com/helper/kb/bookstrap/test.php?xh=%E5%AD%A6%E5%8F%B7&pw=%E5%AF%86%E7%A0%81">
							<img src="img/8.png">我的课表</a>
					</li>
					<li>
						<a href="">
							<img src="img/6.png">教学评价</a>
					</li>
					<li>
						<a href="">
							<img src="img/3.png">小组讨论</a>
					</li>
					<li>
						<a href="">
							<img src="img/4.png">发起考勤</a>
					</li>
					<li>
						<a href="../main/sch_inform.html">
							<img src="img/7.png">教务通知</a>
					</li>
					<li>
						<a href="">
							<img src="img/9.png">学习资源</a>
					</li>
					<li>
						<a href="">
							<img src="img/5.png">交流分享</a>
					</li>
					<li>
						<a href="http://www.lib.gdpu.edu.cn/opac/weixin/account/service/index">
							<img src="img/2.png">微图书馆</a>
					</li>
