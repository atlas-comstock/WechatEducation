...
<script>
	...
	window.onload = function() {
		...
		RongIMClient.getInstance().setOnReceiveMessageListener(
                ...
                document.getElementById("new_msg").innerHTML += '<article class="am-comment"> <li> <a href="#link-to-user-home"> <img src="" alt="" class="am-comment-avatar user_head"/> </a> <div class="am-comment-main content_frame"> <div class="am-comment-meta content-detail" style="overflow-y: auto"> <a href="#link-to-user" class="am-comment-author">某人</a> 评论于 <time datetime="2013-07-27T04:54:29-07:00" title="2013年7月27日 下午7:54 格林尼治标准时间+0800">2014-7-12 15:30</time> <br>' + message .getContent() + "</div></div> </li>";
